  ...
  return (
    <div className="sidebar" style={{ 
      ...
      <style>{`
        ...
        .wallet-btn.wrong-network:hover {
          color: #f87171;
        }
        .logo-container {
          width: 40px;
      ...
      <div className="logo-container">
        <img src="/logo.png" alt="Brokex" style={{ width: '24px', height: 'auto', display: 'block' }} />
      </div>
                ...
                {(() => {
                  if (!connected) {
                    return (
                      <button 
                        ...
                        title="Connect Wallet (Flare Coston2)"
                      >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  if (chain.unsupported) {
                    return (
                      <button 
                        ...
                        className="wallet-btn wrong-network" 
                        title="Wrong Network - Switch to Flare Coston2"
                      >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  return (
                    <button 
                      ...
                      title={`${account.displayName} (${chain.name})`}
