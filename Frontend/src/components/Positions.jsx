...
export default function Positions() {
  ...
  const handleClosePosition = async (item) => {
    ...
    const isXRP = rawAssetStr.includes('xrp') || rawAssetStr === xrpHash.toLowerCase() || rawAssetStr === '0x0aa350274fca23e3884be19de980198b13f2ea293ea26921055ab6a20770c7f2';
  ...
  const parseTrade = (raw) => {
    ...
    const isXRP = rawAssetStr.includes('xrp') || rawAssetStr === xrpHash || rawAssetStr === '0x0aa350274fca23e3884be19de980198b13f2ea293ea26921055ab6a20770c7f2';
