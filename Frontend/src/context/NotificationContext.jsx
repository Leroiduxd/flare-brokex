...
const CONFIG = { explorerUrl: import.meta.env.VITE_EXPLORER_URL || import.meta.env.VITE_COSTON2_EXPLORER_URL || 'https://coston2-explorer.flare.network' };
...
export function NotificationProvider({ children }) {
  ...
  const showNotification = useCallback((message, type = 'info', txHash = null, duration = 5000) => {
        ...
        {notifications.map((n) => {
          ...
          return (
            ...
            >
              ...
              {n.txHash && (
                <a
                  href={`${CONFIG.explorerUrl}/tx/${n.txHash}`}
                  target="_blank"
